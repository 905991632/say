	...
	<div class="nowplace">
		<div>
			&nbsp;当前位置:&nbsp; <a href="index">首页</a> <span> > </span> <a
				href="toPersonal">教师中心</a> <span> > 修改密码</span>
		</div>
	</div>
	<!-- 主内容 -->
	<div class="main_div">
		...
		<div class="right_div">
			...
			<div class="right_div_div2">
				<form action="teacher_alterPassword" method="post"
					onsubmit="return f_submit();">
					<div class="form-group">
						<label class="col-sm-2 control-label">旧密码：</label>
						<div class="col-sm-10">
							<input type="password" class="form-control" name="old_password"
								id="old_password" required onblur="f_old_password();">
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="password" class="form-control" name="new_password"
								id="new_password" required onblur="f_new_password();">
						</div>
