...
CREATE TABLE `teacher` (
  ...
  `permission` int(11) NOT NULL COMMENT '0,1,2不通过、通过、审核',
  `photo` varchar(200) NOT NULL COMMENT '头像',
...
insert  into `teacher`(`id`,`permission`,`photo`,`idcard`,`name`,`sex`,`age`,`mobile`,`courses`,`address`,`area`,`price`,`loginTime`,`loginId`) values (2,2,'images/teacher/photo/teacher.jpg',NULL,'教师1','女',23,'15626463411',NULL,'广东,广州',NULL,NULL,'2018-01-24 18:43:14',13),(3,2,'images/teacher/photo/teacher.jpg',NULL,'教师2','男',22,'15626463411',NULL,'广东,广州',NULL,NULL,'2018-01-17 09:49:51',21),(4,0,'images/teacher/photo/teacher.jpg',NULL,'教师3','男',11,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-02-10 10:03:51',25),(5,2,'images/teacher/photo/teacher.jpg',NULL,'教师4','女',4,'15626463411','二年级语文,二年级数学,二年级英语,三年级语文,三年级数学','广东,中山','西区街道,南区街道,五桂山街道,火炬开发区,黄圃镇','100元/小时','2018-02-02 20:14:33',26),(6,0,'images/teacher/photo/teacher.jpg',NULL,'教师5','男',5,'15626463411','一年级英语,二年级语文,二年级数学,二年级英语,三年级语文','广东,中山','五桂山街道,火炬开发区,黄圃镇','100元/小时','2018-01-29 13:16:30',27),(7,0,'images/teacher/photo/teacher.jpg',NULL,'教师6','女',6,'15626463411','二年级数学,二年级英语,三年级语文,三年级数学,三年级英语','广东,中山','南区街道,五桂山街道,火炬开发区,黄圃镇,南头镇','100元/小时','2018-01-30 18:58:21',28),(8,0,'images/teacher/photo/teacher.jpg',NULL,'教师7','女',7,'15626463411','五年级数学,五年级英语,六年级语文,六年级数学,六年级英语','广东,中山','东区街道,西区街道,南区街道,五桂山街道,神湾镇','100元/小时','2018-01-24 18:01:30',29),(9,0,'images/teacher/photo/teacher.jpg',NULL,'教师8','男',8,'15626463411','二年级英语,三年级语文,三年级数学,三年级英语,四年级语文','广东,中山','东区街道,西区街道,南区街道,五桂山街道,火炬开发区','100元/小时','2018-02-02 20:39:54',30),(10,0,'images/teacher/photo/teacher.jpg',NULL,'教师9','女',19,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:41:33',31),(11,0,'images/teacher/photo/teacher.jpg',NULL,'教师10','女',31,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:42:17',32),(12,0,'images/teacher/photo/teacher.jpg',NULL,'教师11','男',11,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:43:26',33),(13,0,'images/teacher/photo/teacher.jpg',NULL,'教师12','女',35,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:53:40',34),(14,0,'images/teacher/photo/teacher.jpg',NULL,'教师13','男',13,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:54:21',35),(15,0,'images/teacher/photo/teacher.jpg',NULL,'教师14','女',24,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 13:55:09',36),(16,0,'images/teacher/photo/teacher.jpg',NULL,'教师15','男',25,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 14:31:05',37),(17,0,'images/teacher/photo/teacher.jpg',NULL,'教师16','女',26,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 14:31:47',38),(18,0,'images/teacher/photo/teacher.jpg',NULL,'教师17','男',27,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 14:32:23',39),(19,0,'images/teacher/photo/teacher.jpg',NULL,'教师18','女',28,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-29 21:08:06',40),(20,0,'images/teacher/photo/teacher.jpg',NULL,'教师19','男',29,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 14:34:26',41),(21,0,'images/teacher/photo/teacher.jpg',NULL,'教师20','女',20,'15626463411',NULL,'广东,中山',NULL,NULL,'2018-01-23 14:41:18',42);

/*Table structure for table `tutor_live` */

DROP TABLE IF EXISTS `tutor_live`;

CREATE TABLE `tutor_live` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `teacherid` int(11) NOT NULL COMMENT '教师编号',
  `permission` int(11) NOT NULL COMMENT '权限,0申请,1成功,2失败',
  `rtmpurl` varchar(200) DEFAULT NULL COMMENT 'rtmp的url',
  `rtmpkey` varchar(100) DEFAULT NULL COMMENT 'rtmp的key',
  `createtime` datetime NOT NULL COMMENT '申请时间',
  `address` varchar(50) NOT NULL COMMENT '地区',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

/*Data for the table `tutor_live` */

insert  into `tutor_live`(`id`,`teacherid`,`permission`,`rtmpurl`,`rtmpkey`,`createtime`,`address`) values (1,3,1,'rtmp://139.199.75.20/Mylive','91b4eab3-87a5-4624-8ae2-72fd6e0d5d78','2018-02-08 15:11:56','广东,中山'),(2,4,1,'rtmp://139.199.75.20/Mylive','78bad258-42ec-4d5f-8200-6f68b746c34e','2018-02-08 19:41:42','广东,中山');
